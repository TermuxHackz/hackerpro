...
echo -e "${RED}                  ~ Tools for Hacking by Termux-Android-Hackers Admin ${NC}"
echo ""
echo -e "${YELLOW} http://technicaldada.in | https://facebook.com/AnonyminHack5.in | https://github.com/TermuxHack ${NC} "
echo ""
echo "---------------------------------------------------------------------------------------"
echo ""
...
echo "[✔] Installing ...";
echo "";
git clone https://github.com/TermuxHackz/hackerpro "$INSTALL_DIR";
echo "#!/bin/bash
